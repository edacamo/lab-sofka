...
@Configuration
@Profile("!prod") // Solo habilitado si el perfil activo NO es 'prod'
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("API MICROSERVICE-PERSONS")
                        .description("Documentación interactiva para los servicios REST de microservice-persons")
                        .version("1.0.0")
                        .contact(new Contact()
